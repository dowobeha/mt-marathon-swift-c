...
main.o DataOnGPU.o: main.swift toy-Bridging-Header.h DataOnGPU.swift
	swiftc -module-name toy -target ${SWIFT_TARGET} -sdk ${SWIFT_SDK} -import-objc-header toy-Bridging-Header.h -c main.swift -c DataOnGPU.swift
...
clean:
	rm -f toy toy.swiftmodule toy.swiftdoc toy.h UserInput.o main.o main.h main.swiftmodule main.swiftdoc saxpy.o *.o
