...
toy: main.o UserInput.o saxpy.o cuda.o cublas.o
	swiftc -target ${SWIFT_TARGET} -sdk ${SWIFT_SDK} cuda.o main.o UserInput.o saxpy.o cublas.o -o toy -L/usr/local/cuda/lib -lcuda -lcudart -lcublas -F/Library/Frameworks -module-name toy 
