...
toy: main.o my_sample_C_code.o my_sample_cuda_code.o cuda.o cublas.o
	swiftc -target ${SWIFT_TARGET} -sdk ${SWIFT_SDK} -L/usr/local/cuda/lib -lcuda -lcudart -lcublas -F/Library/Frameworks cuda.o main.o my_sample_C_code.o my_sample_cuda_code.o cublas.o -o toy -module-name toy 
